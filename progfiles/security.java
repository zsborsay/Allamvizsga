...
.defaultSuccessUrl("/#!/handleSuccessLogin").loginProcessingUrl("/perform_login")
.failureHandler(authenticationFailureHandler).and().logout().logoutSuccessUrl("/#!/handleSuccesLogout")
